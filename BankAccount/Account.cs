...
namespace BankAccount
{
    ...
    public class Account
    {
        ...
        /// <summary>
        /// Checks is Owner name is less than or equal to 20 characters, A-Z
        /// and whitespace characters are allowed
        /// </summary>
        /// <returns>True if ownerName is valid</returns>
        ...
        /// </summary>
        /// <param name="amt">The positive amount to be removed</param>
        ...
        public double Withdraw(double amt)
        {
            ...
            {
                throw new ArgumentException($"{nameof(amt)} must not be greater than balance");
            }
            Balance -= amt;
            return Balance;
        }
